...
class EsCt extends Es
{
    protected function getHolidays($year)
    {
        ...
        $data[] = new Holiday($easter->modify("+50 days")->format('d.m.Y'), "Pfingstmontag", $timezone, Holiday::PARTIAL);
        $data[] = new Holiday("24.06." . $year, "Johannes der Täufer", $timezone);
        $data[] = new Holiday("11.09." . $year, "Katalonien-Tag", $timezone);
        $data[] = new Holiday("26.12." . $year, "San Esteban", $timezone, Holiday::PARTIAL);
