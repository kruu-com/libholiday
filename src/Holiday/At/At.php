...
class At extends Calculator
{
    /**
     * Get public holidays valid in states of Austria as well as special holidays not valid in states of Austria.
     * @param int $year
     * @return array
     */
    ...
    /**
     * Get _public holidays_ only. Not in all states of Austria days from getSpecial() are public holidays.
     *
